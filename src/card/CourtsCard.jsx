    ...
    <div>
      <div className="bg-[#ffffff] rounded-[14px] w-[273px] p-5 h-[300px]">
        <div className="relative">
          ...
          />
          <div
            className={`font-Poppins text-[11px] px-[10px] py-[2px] rounded-full absolute ${
              card.isAvailable ? "bg-green-900" : "bg-red-900"
            } text-[#ffffff] top-[-8px] left-0`}
          >
            {card.isAvailable ? "COMING SOON" : "COMING SOON"}
          </div>
        </div>

        <div className="mt-[20px]">
          <div className="flex items-center justify-between mt-3">
            <h1 className="font-Poppins text-[12px] font-black inline ml-1 uppercase break-words">
              {card.location}
            </h1>
