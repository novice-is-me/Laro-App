  ...
  return (
    <div className='w-[100%] h-full flex items-center justify-center relative'>
        <div className='h-[70%]  relative'>
            ...
            <div className='bg-black rounded-[40px] flex items-center p-4 absolute top-[80px] left-[-80px]'  >
                ...
                <h1 className='text-[#ffffff] mx-[20px] font-Poppins text-3xl'>Book</h1>
            </div>

            <div className='bg-black rounded-[40px] flex items-center p-4 absolute bottom-[-30px] left-[-80px]'  >
                <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
                ...
                <h1 className='text-[#ffffff] mx-[20px] font-Poppins text-3xl'>Organize</h1>
            </div>

            <div className={`bg-[#fa5000] w-fit rounded-[40px] flex items-center p-4 absolute bottom-[120px] border-2 border-white right-[-80px]`}  >
                <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
                ...
                <h1 className='text-[#ffffff] mx-[20px] font-Poppins text-3xl'>Play</h1>
            </div>
        </div> 
    </div>
  )
...
export default CourtImgComponent
