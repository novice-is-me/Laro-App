...
const CourtImgComponent = ({img}) => {
  return (
    <div className='w-[50%] h-full flex items-center justify-center relative pt-[5rem] 1110:pt-0'>
        <div className='h-[70%] sm:h-full relative'>
            <img src={img} alt=""
             className='h-full' /> 
            ...
            <div className='bg-black rounded-[40px] flex items-center p-2 absolute bottom-[-30px] left-[-80px]'  >
                <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
            ...
            <div className={`bg-[#fa5000] w-fit rounded-[40px] flex items-center p-2 absolute bottom-[120px] border-2 border-white right-[-80px]`}  >
                <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
                ...
                <h1 className='text-[#ffffff] mx-[12px] font-Poppins text-xl'>Play</h1>
            </div>
        </div> 
    </div>
  )
