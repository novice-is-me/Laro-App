...
const PictureComponent = ({img,value}) => {
    return ( 
        <div className='w-[100%] flex items-between justify-start relative ml-40 1110:scale-75 1110:ml-20 950px:ml-14 sm:scale-50 sm:mb-32 sm:mr-10'>
            <div className='bg-[#fa5000] w-[400px] h-[450px] relative rounded-lg '>
                <img src={img} alt="" className={`absolute bottom-0 right-2 max-w-none ${value === 'create' ? 'right-0 w-[375px]': "right-0 w-[375px]"}`}/>

                <div className='bg-black w-fit h-[55px] rounded-[40px] flex items-center pl-[10px] absolute top-[20px] left-[-40px]'  >
                ...
                <div className='bg-black w-fit h-[55px] rounded-[40px] flex items-center pl-[10px] absolute bottom-[20px] left-[-20px]'  >
                    <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
                ...
                pl-[10px] absolute left-[330px] bottom-[180px] border-2 border-white ${value === 'login' || value === 'create' ? 'right-[5px]' : 'right-[-150px]' }`}  >
                    <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
