...
import Dp from "../assets/Active Match/activematch3.jpg"
import RefreshIcon from "@mui/icons-material/Refresh";
import DashBoardCard from "../components/DashBoardCard";
import { useNavigate } from "react-router";
import "./UserNav.css"

const UserNav = ({ isOpen, setIsOpen, toggleOff }) => {
  ...
  return (
    <div className="w-[450px] h-screen flex flex-grow flex-col py-5 2xl:justify-between items-center lg:gap-2 1110:h-fit 1110:py-0">
      ...
      <div className={`h-full flex flex-col bg-white ${isOpen ? '1110:flex 1110:fixed 1110:z-10 1110:left-0 1110:top-0' : '1110:hidden'}`}>
        ...
        <div className="w-full 2xl:h-fit flex items-center gap-5 p-5">
          <svg
            ...
            <div className="flex gap-2 w-full 2xl:flex-col">
              ...
              <div className="flex flex-col gap-5 justify-between w-full m-2-green-500">
        ...
        {/* Middle Part */}
        <div className="w-full h-full justify-evenly flex flex-col font-Inter font-medium">
          {/* Overview */}
          <div className="flex justify-around items-center cursor-pointer" onClick={() => navigate("/user")}>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="35"
                height="40"
                viewBox="0 0 40 40"
            ...
            <div className="flex items-center w-1/2 ">
              <p className="text-2xl 2xl:text-xl">Overview</p>
            </div>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="35"
          ...
          {/* Statistics */}
          <div className="flex justify-around items-center cursor-pointer" onClick={() => navigate("/user/statistics")}>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="37"
                height="35"
          ...
          {/* Matches */}
          <div className="flex justify-around items-center cursor-pointer" onClick={() => navigate("/user/matches")}>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="40"
                height="40"
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M30.7953 35.0847C39.1603 29.2269 41.1924 17.6964 35.3346 9.33137C29.4788 0.966355 17.9482 -1.06573 9.5832 4.79385M30.7953 35.0847C22.4303 40.9405 10.8997 38.9085 5.04198 30.5434C-0.813896 22.1784 1.21819 10.6479 9.5832 4.79385M30.7953 35.0847L9.5832 4.79385"
                  stroke="#717171"
                  stroke-width="1.5"
            ...
            <div className="flex items-center w-1/2 ">
              <p className="text-2xl 2xl:text-xl">Matches</p>
            </div>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="35"
          ...
          {/* Achievements */}
          <div className="flex justify-around items-center cursor-pointer" onClick={() => navigate("/user/achievements")}>
            <div className="flex justify-center w-1/4 xl:invisible ">
            <svg
              width="26"
              height="39"
          ...
          {/* Shops */}
          <div className="flex justify-around items-center cursor-pointer" onClick={() => navigate("/user/shop")}>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
              width="45"
              height="45"
            ...
            <div className="flex items-center w-1/2 ">
              <p className="text-2xl 2xl:text-xl">Shops</p>
            </div>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="35"
          ...
          {/* Logout */}
          <div className="flex justify-around items-center cursor-pointer 1110:hidden" onClick={handleLogout}>
            <div className="flex justify-center w-1/4 xl:invisible">
              <svg
                width="35"
                height="40"
            ...
            <div className="flex items-center w-1/2 ">
              <p className="text-2xl 2xl:text-xl">Logout</p>
            </div>
            <div className="flex justify-center w-1/4 xl:invisible ">
              <svg
                width="40"
        ...
        <div className="w-full flex justify-center items-center">
          <div className="flex flex-col gap-5 w-3/4 p-5 rounded-xl bg-orange font-Poppins text-white text-base shadow-xl">
            <p className="font-semibold w-2/3 2xl:text-sm 2xl:w-full 2xl:text-center">Be part of our organizer team and earn money.</p>
            <button className="bg-black p-5 rounded-lg 2xl:text-sm 2xl:p-3">Apply Now</button>
          </div>
        </div>
      </div>
    </div>
