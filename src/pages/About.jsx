  ...
  return (
    <div className='bg-bgColor w-full px-9 py-3 relative'>
      ...
      pb-0  items-center gap-[10rem] mb-12'>  
        ...
        <div className='z-[1] flex flex-col mt-auto gap-[15rem] pr-[15rem]'>   
          <div className=''> 
            <h1 className='font-poppins uppercase text-[40px] font-bold mb-8'>
              About Laro</h1>
            <p className='font-poppins text-[#818181] text-[18px]'>This innovative platform revolutionizes the landscape of basketball 
              bookings by offering a streamlined system where users can effortlessly 
              book, organize, manage, and securely pay for their games. With a focus 
              on efficiency and user-friendly features, it transforms the traditional 
