        ...
        <div className='z-[1] flex flex-col mt-auto gap-[8rem] xl:pt-8 xl:gap-4 xl:mt-0 ' >
          <div className='w-[90%]'>
            <h1 className='font-poppins uppercase text-[40px] font-bold mb-8 '>
              About Laro</h1>
            <h1 className='font-poppins  text-[30px] font-bold mb-8 '>
              Work-life balance isn't just a goal, its a way of life </h1>
              <p className=' font-poppins text-black text-[18px] xl:text-white w-full text-justify'>
              At Laro, we believe ambition doesn't have to come at the cost of well-being.
               ...
               you to conquer whataever life brings you</p>
          </div>
