  ...
  return (
    ...
    <div className='bg-bgColor w-full px-9 py-3 relative'>
      ...
      pb-0  items-center gap-[10rem] mb-12  xl:about-bg2 xl:gap-1 xl:pb-8 sm:text-center'>  
        ...
        <div className='z-[1] flex flex-col mt-auto gap-[15rem] xl:pt-8 xl:gap-4
         xl:mt-0'>
          <div className=''>
            <h1 className='font-poppins uppercase text-[40px] font-bold mb-8'>
              About Laro</h1>
            <p className='font-poppins text-[#818181] text-[18px] xl:text-white'>
              This innovative platform revolutionizes the landscape of basketball
