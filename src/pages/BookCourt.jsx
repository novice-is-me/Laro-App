...
const   BookCourt = ({ setMain }) => {
    ...
    return (
        <div className='w-full h-[79vh] flex font-Poppins 1110:justify-center 1110:h-full'>
            <div className='flex flex-col justify-center px-20 gap-10 w-[60%] 1110:w-full sm:px-10'>
                <div className='flex flex-col 1110:w-full 1110:items-center 1110:gap-2'>
                    ...
                    <div className='hidden 1110:flex py-5 xsm:scale-75 xsm:py-0'>
                ...
                <div className='flex gap-5 1110:justify-center 1110:gap-10 sm:flex-col sm:items-center sm:gap-0'>
                    <div className='shadow-xl sm:shadow-none'>
                        <Calendar 
                    ...
                    <div className='flex flex-col justify-between sm:flex sm:flex-col sm:items-center sm:w-full sm:gap-5'>
                        ...
                        <div className='flex flex-col w-2/3 gap-2'>
                            ...
                            <div className='sm:flex items-center gap-10'>
                                <p className='text-[12px] font-semibold'>Parking Slot</p>
                            ...
                            <div className='sm:flex items-center gap-10'>
                                <p className='text-[12px] font-semibold'>Buzzer and Timer</p>
                            ...
                            <div className='sm:flex items-center gap-10'>
                                <p className='text-[12px] font-semibold'>Number of Seats</p>
            ...
            <div className='w-[50%] flex items-center justify-center xl:w-[30%] xl:scale-[0.9] 1110:hidden'>
                <div className='w-[100%]  flex items-center justify-center relative'>
                    <div className='w-[320px] h-[400px] relative'>
                        <img src={bookcourt} alt="" className='absolute bottom-0 w-[100%] h-[100%] rounded-lg' />
