...
const DashboardCourtOwner = () => {
  ...
  return ( 
     <div className='flex  w-full p-4 gap-4 relative'>
        ...
        <div className='bg-bgColor p-10 pt-5 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
            ...
            {error && <p className='font-Poppins font-semibold text-red-600'>Please complete all fields</p>}
            <p className='text-2xl font-Poppins mb-[2rem] font-semibold'>Edit Information</p>
            <form action="" className='flex flex-col gap-4' onSubmit={handleSubmit}>
                <div className='flex flex-col'>
                    <label htmlFor="" className='font-Poppins font-semibold'>Name:</label>
                    <input type="text" 
                    required
                    value={changeOwner} 
                    onChange={(e) => setChangeOwner(e.target.value)}
                    className='text-xl font-poppins p-4 bg-[#FFEEE6] outline-none' />
                    {!changeOwner && <p className='font-Poppins text-red-600'>Input a username</p>}
                </div>
                <div className='flex flex-col'>
                    <label htmlFor="" className='font-Poppins font-semibold'>Address</label>
                    <input type="text" 
                    required
                    value={changeAdd}
                ...
                <button className='bg-orange font-Poppins text-xl py-3'>Change</button>
            </form>
        </div>}
                            ...
                            <div className=' w-full'>
                                <div className='flex gap-8 items-center justify-between'>
                                    ...
                                    <svg width="17" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" 
                                     ...
                                     onClick={(e) => setModal(!modal)}/></svg>                                    </div>
                                ...
                                <div className=' flex justify-between border-b-2 border-white m-4 pb-4'>
                                    <div> 
                                        ...
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <p className='font-Inter text-[15px]'>{owner}</p>
                                        </div>
                                    </div>
                                    <div className='px-4'>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            ...
                                            <p className='font-Inter text-[15px]'>{address}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
