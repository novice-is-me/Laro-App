...
import { CourtImg, emojiCool, emojiSad, emojiShock, emojiSmirk, ownerImg } from '../assets'
...
const DashboardCourtOwner = () => {
  return (
     <div className='flex border border-yellow-950 w-full p-4 gap-4'>
        {/* for profile */}
        <div className=' flex border border-yellow-500 flex-1'>
            <div>
        ...
        <div className='flex flex-col border border-red-500 flex-[3] h-full gap-8'>
                    ...
                    <div className='flex border w-full'>
                        <div className='flex gap-8 w-full'>
                            ...
                            <div className='bg-black p-4 text-white w-[50%] rounded-[10px]'>
                                <p className=' font-Inter font-semibold text-[20px]'>Adds Here</p>
                            </div>
                        </div>
                    </div>
            ...
            {/* upcoming events */}
            <div className=' flex  gap-8 border border-blue-600 w-full'>
                <div className=' flex bg-black text-white w-[58%] rounded-[10px]
                 px-4 py-12 gap-4'>
                    <div>
                        <img src={emojiShock} alt="" className=' h-auto w-[250px]' />
                    </div>
                ...
                <div className='flex border border-green-500 w-[40%] gap-2'>
            ...
            {/* for image */}
            <div className=' flex border border-yellow-900 gap-8'>
                <div className='flex gap-4 border border-violet-500 w-[60%]'>
                    <div className=' border border-red-900 w-[50%] text-center'>
                    ...
                    <div className=' border border-amber-600 w-[50%] text-center '>
                        <div className='flex flex-col border border-yellow-300 h-full'>
                            <p className=' font-Poppins font-semibold text-[16px] mb-2'>Earnings</p>
                ...
                <div className=' border border-green-400 w-[41%]'>
