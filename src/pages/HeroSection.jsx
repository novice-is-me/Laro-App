...
const HeroSection = () => {
  return (
    ...
    <div className='absolute top-[300px] right-[90px] transform -translate-y-1/2 translate-x-1/4 xl:right-[30px] xl:top-auto xl:translate-y-0
  xsm:top-[155px] xsm:right-[40px] 950px:top-[150px] 950px:right-[225px] sm:right-[50px]  '>
  <div className='bg-orange  border-white border-4 w-fit h-[55px] rounded-[40px] flex items-center pl-[10px] '>
    <div className='w-[40px] h-[40px] bg-[#ffffff] rounded-[50%] flex self-center justify-center'>
    ...
    <div className='absolute bottom-[60px] 950px:bottom-[20px] 950px:left-[20px] xsm:bottom-[20px] xsm:left-[5px] left-[-20px] xl:bottom-[60px] xl:left-[-40px] transform -translate-x-1/4 flex justify-center w-fit'>
        <div className='bg-black w-fit h-[55px] rounded-[40px] flex items-center pl-[10px]'>
