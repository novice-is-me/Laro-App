...
const JoinViewActiveMatches = ({ setMain }) => {
    return (
        <div className='font-Poppins'>
            <Link to='/matches' className='font-bold flex' onClick={() => setMain('default')}>
                <KeyboardArrowLeft />
                <p>Back</p>
            </Link>
            <div className='bg-bgColor border-2 w-full box-border flex font-Poppins px-9 gap-6 py-4 lg:flex-col lg:px-20 xsm:px-4'>
                ...
                <div className='flex-[60%] sm:p-0 pr-20 lg:pr-0'>
                    ...
                    <div className='flex w-full justify-between mb-2 md:flex-col'>
                        ...
                        <div className='w-[330px] min-h-[80px] bg-[#ffffff] rounded-lg border-orange border-[1px] pl-4 py-3 lg:mx-auto mb-3 xsm:w-full'>
                            <h1 className='font-bold text-sm'>Hoop Basketball Team</h1>
                            <p className=' text-gray'>Organizer</p>
                        </div>

                        <div className='w-[330px] bg-[#ffffff] rounded-lg border-orange border-[1px] px-4 py-3 lg:mx-auto mb-3 xsm:w-full'>
