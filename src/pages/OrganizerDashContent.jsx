                    ...
                    <div className='flex justify-center items-end gap-5 w-full h-fit px-10 py-2.5'>
                        ...
                        <div className='flex flex-col justify-between px-10 py-5 w-1/2 h-[265px] rounded-[10px] text-white font-Inter bg-black'>
                            ...
                            <div className='flex items-end w-full h-full'>
                                <p className='text-[15px] font-light'>You need to reach 10,000 before checkout.</p>
                            </div>   
                        </div>
                    ...
                    <div className='flex justify-center items-center gap-5 w-full h-fit px-10 py-2.5'>
                        ...
                        <div className='flex flex-col justify-between px-10 py-5 w-1/2 h-[537px] rounded-[10px] gap-5 text-white font-Inter bg-orange'>
                            ...
                            <div className='flex justify-center text-black w-full h-full'>
                                <Calendar className='w-full h-fit font-Poppins' formatShortWeekday={(locale, date) => weeks[date.getDay()]}/>
                            </div>
                        </div>
            ...
            {activeTab === 'Activities' && (
                <div className='flex flex-col items-center w-full h-screen px-5 gap-5'>
                    ...
                    <div className='flex justify-between w-full p-5 text-[25px] font-Inter shadow-lg'>
                        <button className='w-[185px] h-[65px] rounded-[200px] text-white font-bold bg-orange'>This week</button>
                    ...
                    <div className='w-full h-full flex flex-col py-5 gap-5 overflow-y-auto'>
                        ...
                        <div className='flex flex-col px-10 py-5 gap-5 w-full h-fit rounded-[20px] font-Inter border border-[#B0B0B0] shadow-lg'>
                            <div className='flex justify-between'>
                                <p className='text-[30px] text-orange font-semibold'>Game Event No. 1</p>
                                <p>Image Arrow Button</p>
                            </div>
                            <p className='text-[25px] text-[#525252]'>Saturday, March 16, 2024. Mandaluyong Court</p>
                        </div>

                        <div className='flex flex-col px-10 py-5 gap-5 w-full h-fit rounded-[20px] font-Inter border border-[#B0B0B0] shadow-lg'>
                            <div className='flex justify-between'>
                                <p className='text-[30px] text-orange font-semibold'>Game Event No. 2</p>
                                <p>Image Arrow Button</p>
                            </div>
                            <p className='text-[25px] text-[#525252]'>Saturday, March 16, 2024. Mandaluyong Court</p>
                        </div>
                        ...
                        <div className='flex flex-col px-10 py-5 gap-5 w-full h-fit rounded-[20px] font-Inter border border-[#B0B0B0] shadow-lg'>
                            <div className='flex justify-between'>
                                <p className='text-[30px] text-orange font-semibold'>Game Event No. 3</p>
                                <p>Image Arrow Button</p>
                            </div>
                            <p className='text-[25px] text-[#525252]'>Saturday, March 16, 2024. Mandaluyong Court</p>
                        </div>
                        ...
                        <div className='flex flex-col px-10 py-5 gap-5 w-full h-fit rounded-[20px] font-Inter border border-[#B0B0B0] shadow-lg'>
                            <div className='flex justify-between'>
                                <p className='text-[30px] text-orange font-semibold'>Game Event No. 4</p>
                                <p>Image Arrow Button</p>
                            </div>
                            <p className='text-[25px] text-[#525252]'>Saturday, March 16, 2024. Mandaluyong Court</p>
                        </div>
                        ...
                        <div className='flex flex-col px-10 py-5 gap-5 w-full h-fit rounded-[20px] font-Inter border border-[#B0B0B0] shadow-lg'>
                            <div className='flex justify-between'>
                                <p className='text-[30px] text-orange font-semibold'>Game Event No. 5</p>
                                <p>Image Arrow Button</p>
                            </div>
                            <p className='text-[25px] text-[#525252]'>Saturday, March 16, 2024. Mandaluyong Court</p>
                        </div>
                        ...
                        <div className='flex flex-col px-10 py-5 gap-5 w-full h-fit rounded-[20px] font-Inter border border-[#B0B0B0] shadow-lg'>
                            <div className='flex justify-between'>
                                <p className='text-[30px] text-orange font-semibold'>Game Event No. 6</p>
                                <p>Image Arrow Button</p>
                            </div>
                            <p className='text-[25px] text-[#525252]'>Saturday, March 16, 2024. Mandaluyong Court</p>
                        </div>
