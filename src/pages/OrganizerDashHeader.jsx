    ...
    return (
        <div className="container flex flex-row gap-4 h-full border" style={{ height: '100vh' }}>
            <div className="header w-[25%]">
                ...
                <div className='mt-14 ml-4 mr-5 hover:cursor-pointer border w-[10%]' onClick={() => navigate('/organizer')}>
                    ...
                    <div className='border h-[200px] w-auto flex overflow-hidden p-2'>
...
<div className='border mt-4 flex justify-between w-[100%] h-[100%]'>
                                    <div className="flex flex-col gap-10 justify-between pt-4 w-[100%]  ">
            <div className='flex flex-col border'>
            <button 
    onClick={() => onTabChange('Overview')}
    className={`flex items-center justify-between ${activeTab === 'Overview' ? 'text-black' : 'text-[#787878]'}`}
>
 
    <svg width="25" height="30" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<button 
    ...
    className={`flex items-center justify-between  ${activeTab === 'Activities' ? 'text-black' : 'text-[#787878]'}`}
>
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"  viewBox="0 0 16 16"> <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/> <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/> </svg>
    ...
    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
        <path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" fill={activeTab === 'Activities' ? 'black' : '#787878'}/>
            ...
            <div className='flex flex-col border'>
            <button onClick={handleLogout} className={`flex items-center justify-between hover:cursor-pointer mt-auto ${activeTab === 'Logout' ? 'active' : ''}`}>
    <svg width="25" height="30" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
