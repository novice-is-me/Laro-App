...
const OrganizerMatches = () => {
  return (
    <div className="bg-black min-h-screen flex justify-center items-center pt-10 px-4 overflow-x-auto">
    <div className="bg-white rounded-[50px] pl-20 pt-4 flex flex-col relative w-full h-auto lg:mr-2 mb-10 lg:mb-0 lg:pl-4 lg:overflow-x-auto">
      <div className="flex lg:flex lg:justify-start p-4 mb-4 pb-4  ">
          
          <Link to="/">
            <div className=" cursor-pointer   lg:w-[90%] ">
              <img src={Logo} alt="Logo" className="h-[34px] w-[100%]"/>
            </div>
          </Link>
        ...
        <div className='h-full w-full flex flex-row gap-4 '>
                    <div className='pl-7  w-[5%] h-full pt-14 lg:pt-4 '>
                        <svg 
                            width="22" 
                            height="35" 
                            viewBox="0 0 22 35" 
                    ...
                    <div className=" pl-10 h-full w-full flex flex-row gap-14 ">
                      <div className=" h-full w-[65%] flex flex-col  gap-4  lg:w-auto">
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[90px] flex  justify-center flex-col pl-8 pt-2">
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[110px] flex  justify-center flex-col pl-8 pt-2 gap-4">
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] flex flex-row h-[90px]  pl-8 pt-2">
  ...
  <StarRating rating={4} size="62px" /> {/* Adjust size as needed */}
</div>
                      ...
                      <img src={success} alt="success" className="flex items-center rounded-[10px] h-[420px] w-full"/>
                      </div>
                      </div>

                      <div className=" w-full gap-4 lg:w-auto">
                      
                      <div className="flex flex-col gap-4  w-[75%] lg:w-auto lg:mr-10">
                      <div className="flex flex-row gap-4  ">
                        <div className="border-2 border-[#FA5000] rounded-[10px] h-[90px] w-1/2 flex  justify-center flex-col pl-8 pt-2">
...
<p className="font-Poppins text-[#575757] text-[15px]">Fee per head</p>
                        ...
                        <div className="border-2 border-[#FA5000] rounded-[10px] h-[110px]  flex justify-center flex-col pl-12 ">
                      ...
                      <p className="font-Poppins text-[#575757] text-[15px]  w-[85%] pl-2 ">Parking Space Available. Free Refilable water, just bring your own bottle. Have referees.</p>
                        ...
                        <div className=" flex flex-col gap-4  w-[75%] mt-2 lg:w-auto lg:mr-10">
                      <div className="  h-auto   ">
                      <p className="font-Poppins font-semibold text-[33px] underline   ">Players</p>

<div className=" flex flex-col gap-1">
                      <div className="flex flex-row gap-10 lg:gap-4">
                        <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                        <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4 ">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people2} alt="people2" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="flex flex-row gap-10 pt-2 lg:gap-4">
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people3} alt="people3" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people4} alt="people4" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people5} alt="people5" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people6} alt="people6" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people7} alt="people7" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people8} alt="people8" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className="border-2 border-[#FA5000] rounded-[10px] h-[auto] w-1/2 flex justify-start flex-row pl-4 pt-2">
                      <div  className="mr-4  flex justify-center items-center pb-2 lg:hidden">
                        <img src={people9} alt="people9" height="40px" width="40px"/>
                        </div>
  ...
  <p className="font-Poppins text-[#FA5000] text-[9px] justify-center items-center pr-4">Remove</p>
                      ...
                      <div className=" flex justify-end items-end  mr-8 gap-10 mt-10 h-[6%]">
